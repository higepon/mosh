...
- R7RS (Experimental)
  ...
  - To demonstrate R7RS comformance, we write [MNIST demo]([mosh/tests/mnist at master · higepon/mosh](https://github.com/higepon/mosh/tree/master/tests/mnist)) in R7RS. It works both with Gauche and Mosh.
