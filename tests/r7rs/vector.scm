...
(import (except (scheme base) string->vector list->vector vector-append vector-copy vector->list vector->string vector-copy! vector-for-each vector-fill! vector-map)
        (scheme vector)
        (mosh chibi test))
