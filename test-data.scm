...
(error (call-with-string-input-port
        ...
        (lambda (in)
          (apply read (list in)))))
(#t (eq? #\A #\x41))
(3 (bytevector-length (make-bytevector 3)))
(#vu8(3 3 3 3) (make-bytevector 4 3))
(#t (bytevector=? #vu8(3 3 3) #vu8(3 3 3)))
(#f (bytevector=? #vu8(3 4 3) #vu8(3 3 3)))
(#vu8(3 3 3 3) (let ([bytevector (make-bytevector 4)])
