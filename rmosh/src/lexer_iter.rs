/* Generated by re2c 3.0 on Mon Apr  3 09:02:06 2023 */
...

                {
                    ...
                    'yyl: loop {
                        match yystate {
                            ...
                            4 => {
                                println!("invalid token {}", self.extract_token());
                            ...
                            8 => {
                                return self.with_location(Token::Identifier {
                            ...
                            10 => {
                                ...
                                match yych {
                                    ...
                                    0x00000045 | 0x00000049 | 0x00000065 | 0x00000069 => {
                                        self.cursor += 1;
                                        yystate = 40;
                                        continue 'yyl;
                                    }
                            ...
                            12 => {
                                return self.with_location(Token::LeftParen);
                            }
                            13 => {
                                return self.with_location(Token::RightParen);
                            }
                            14 => {
                                yyaccept = 0;
                                self.marker = self.cursor;
                            ...
                            20 => {
                                return self.with_location(Token::Number10 {
                                    value: self.extract_token(),
                                });
                            }
                            21 => {
                            ...
                            28 => {
                                ...
                                {
                                    return self.with_location(Token::String {
                            ...
                            46 => {
                                return self.with_location(Token::False);
                            }
                            47 => {
                                yyaccept = 6;
                                self.marker = self.cursor;
                            ...
                            48 => {
                                return self.with_location(Token::True);
                            }
                            49 => {
                                yych = unsafe { *self.s.get_unchecked(self.cursor) as usize };
                                if yych <= 0x00000000 {
                            ...
                            62 => {
                                return self.with_location(Token::Number16 {
                                    value: self.extract_token(),
                                });
                            }
                            63 => {
                            ...
                            81 => {
                                return self.with_location(Token::Regexp {
                                    value: self.extract_regexp(),
                                });
                            }
                            82 => {
                                yych = unsafe { *self.s.get_unchecked(self.cursor) as usize };
                            ...
                            83 => {
                                return self.with_location(Token::DefinedShared {
                                    value: self.extract_defined_shared(),
                                });
                            }
                            84 => {
                                return self.with_location(Token::DefiningShared {
                                    value: self.extract_defining_shared(),
                                });
                            }
                            85 => {
                                yych = unsafe { *self.s.get_unchecked(self.cursor) as usize };
                            ...
                            88 => {
                                return self.with_location(Token::Number2 {
                                    value: self.extract_token(),
                                });
                            }
                            89 => {
                            ...
                            98 => {
                                return self.with_location(Token::Number8 {
                                    value: self.extract_token(),
                                });
                            }
                            99 => {
                            ...
                            102 => {
                                return self.with_location(Token::Character {
                                    value: self.extract_character(),
                                });
                            }
                            103 => {
                                yyaccept = 10;
                            ...
                            194 => match self.extract_hex_character() {
                                Some(ch) => {
