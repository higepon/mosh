...
fn is_number(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "number?";
...
fn cons(vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "cons";
    check_argc!(name, args, 2);
    vm.gc.cons(args[0], args[1])
}
fn consmul(vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "cons*";
...
fn car(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "cons";
...
fn cdr(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "cdr";
    assert_eq!(args.len(), 1);
    match args[0] {
...
fn is_null(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "null?";
    panic!("{}({}) not implemented", name, args.len());
}
fn set_car_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "set-car!";
    panic!("{}({}) not implemented", name, args.len());
}
fn set_cdr_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "set-cdr!";
    panic!("{}({}) not implemented", name, args.len());
}
fn sys_display(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "sys-display";
    panic!("{}({}) not implemented", name, args.len());
}
fn rxmatch(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "rxmatch";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_regexp(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "regexp?";
    panic!("{}({}) not implemented", name, args.len());
}
fn regexp_to_string(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "regexp->string";
    panic!("{}({}) not implemented", name, args.len());
}
fn rxmatch_start(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "rxmatch-start";
    panic!("{}({}) not implemented", name, args.len());
}
fn rxmatch_end(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "rxmatch-end";
    panic!("{}({}) not implemented", name, args.len());
}
fn rxmatch_after(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "rxmatch-after";
    panic!("{}({}) not implemented", name, args.len());
}
fn rxmatch_before(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "rxmatch-before";
    panic!("{}({}) not implemented", name, args.len());
}
fn rxmatch_substring(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "rxmatch-substring";
    panic!("{}({}) not implemented", name, args.len());
}
fn make_string(vm: &mut VmOld, args: &[Object]) -> Object {
...
fn string_set_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
...
fn string_length(_vm: &mut VmOld, args: &[Object]) -> Object {
...
fn string_to_symbol(vm: &mut VmOld, args: &[Object]) -> Object {
...
fn string_to_number(_vm: &mut VmOld, args: &[Object]) -> Object {
...
fn string_append(vm: &mut VmOld, args: &[Object]) -> Object {
...
fn string_split(vm: &mut VmOld, args: &[Object]) -> Object {
...
fn string(vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "string";
...
fn number_to_string(vm: &mut VmOld, args: &[Object]) -> Object {
...
fn reverse(vm: &mut VmOld, args: &[Object]) -> Object {
...
fn is_eof_object(_vm: &mut VmOld, args: &[Object]) -> Object {
...
fn read_char(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "read-char";
    panic!("{}({}) not implemented", name, args.len());
}
fn peek_char(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "peek-char";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_charequal(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "char=?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_string(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "string?";
    check_argc!(name, args, 1);
    match args[0] {
...
fn get_environment_variable(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "get-environment-variable";
    panic!("{}({}) not implemented", name, args.len());
}
fn get_environment_variables(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "get-environment-variables";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_equal(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "equal?";
    panic!("{}({}) not implemented", name, args.len());
}
fn open_string_input_port(vm: &mut VmOld, args: &[Object]) -> Object {
...
fn open_output_string(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "open-output-string";
    panic!("{}({}) not implemented", name, args.len());
}
fn sys_port_seek(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "sys-port-seek";
    panic!("{}({}) not implemented", name, args.len());
}
fn close_output_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "close-output-port";
    panic!("{}({}) not implemented", name, args.len());
}
fn digit_to_integer(_vm: &mut VmOld, args: &[Object]) -> Object {
...
fn get_remaining_input_string(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "get-remaining-input-string";
    panic!("{}({}) not implemented", name, args.len());
}
fn directory_list(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "directory-list";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_file_exists(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "file-exists?";
    panic!("{}({}) not implemented", name, args.len());
}
fn delete_file(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "delete-file";
    panic!("{}({}) not implemented", name, args.len());
}
fn get_output_string(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "get-output-string";
    panic!("{}({}) not implemented", name, args.len());
}
fn string_to_regexp(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "string->regexp";
    panic!("{}({}) not implemented", name, args.len());
}
fn char_to_integer(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "char->integer";
    panic!("{}({}) not implemented", name, args.len());
}
fn integer_to_char(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "integer->char";
    panic!("{}({}) not implemented", name, args.len());
}
fn format(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "format";
    if args.len() == 2 {
...
fn current_input_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "current-input-port";
    panic!("{}({}) not implemented", name, args.len());
}
fn current_output_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "current-output-port";
    panic!("{}({}) not implemented", name, args.len());
}
fn set_current_input_port_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "set-current-input-port!";
    panic!("{}({}) not implemented", name, args.len());
}
fn set_current_output_port_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "set-current-output-port!";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_char(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "char?";
    check_argc!(name, args, 1);
    match args[0] {
...
fn write(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "write";
    panic!("{}({}) not implemented", name, args.len());
}
fn gensym(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "gensym";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_stringequal(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "string=?";
    check_argc!(name, args, 2);
    match args {
...
fn caaaar(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "caaaar";
    panic!("{}({}) not implemented", name, args.len());
}
fn caaadr(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "caaadr";
    panic!("{}({}) not implemented", name, args.len());
}
fn caaar(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "caaar";
    panic!("{}({}) not implemented", name, args.len());
}
fn caadar(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "caadar";
    panic!("{}({}) not implemented", name, args.len());
}
fn caaddr(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "caaddr";
    panic!("{}({}) not implemented", name, args.len());
}
fn caadr(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "caadr";
    panic!("{}({}) not implemented", name, args.len());
}
fn caar(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "caar";
    panic!("{}({}) not implemented", name, args.len());
}
fn cadaar(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "cadaar";
    panic!("{}({}) not implemented", name, args.len());
}
fn cadadr(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "cadadr";
    panic!("{}({}) not implemented", name, args.len());
}
fn cadar(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "cadar";
    panic!("{}({}) not implemented", name, args.len());
}
fn caddar(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "caddar";
    panic!("{}({}) not implemented", name, args.len());
}
fn cadddr(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "cadddr";
    panic!("{}({}) not implemented", name, args.len());
}
fn caddr(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "caddr";
    match args {
...
fn cadr(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "cadr";
    match args {
        [Object::Pair(pair)] => match pair.cdr {
...
fn cdaaar(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "cdaaar";
    panic!("{}({}) not implemented", name, args.len());
}
fn cdaadr(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "cdaadr";
    panic!("{}({}) not implemented", name, args.len());
}
fn cdaar(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "cdaar";
    panic!("{}({}) not implemented", name, args.len());
}
fn cdadar(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "cdadar";
    panic!("{}({}) not implemented", name, args.len());
}
fn cdaddr(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "cdaddr";
    panic!("{}({}) not implemented", name, args.len());
}
fn cdadr(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "cdadr";
    panic!("{}({}) not implemented", name, args.len());
}
fn cdar(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "cdar";
    panic!("{}({}) not implemented", name, args.len());
}
fn cddaar(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "cddaar";
    panic!("{}({}) not implemented", name, args.len());
}
fn cddadr(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "cddadr";
    panic!("{}({}) not implemented", name, args.len());
}
fn cddar(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "cddar";
    panic!("{}({}) not implemented", name, args.len());
}
fn cdddar(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "cdddar";
    panic!("{}({}) not implemented", name, args.len());
}
fn cddddr(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "cddddr";
    panic!("{}({}) not implemented", name, args.len());
}
fn cdddr(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "cdddr";
    panic!("{}({}) not implemented", name, args.len());
}
fn cddr(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "cddr";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_symbolequal(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "symbol=?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_booleanequal(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "boolean=?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_vector(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "vector?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_list(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "list?";
    check_argc!(name, args, 1);
    Object::make_bool(args[0].is_list())
}
fn list(vm: &mut VmOld, args: &[Object]) -> Object {
...
fn memq(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "memq";
    check_argc!(name, args, 2);
    let key = args[0];
    let mut list = args[1];
...
fn is_eq(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "eq?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_eqv(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "eqv?";
    panic!("{}({}) not implemented", name, args.len());
}
fn member(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "member";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_boolean(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "boolean?";
    panic!("{}({}) not implemented", name, args.len());
}
fn symbol_to_string(vm: &mut VmOld, args: &[Object]) -> Object {
...
fn string_ref(_vm: &mut VmOld, args: &[Object]) -> Object {
...
fn get_timeofday(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "get-timeofday";
    panic!("{}({}) not implemented", name, args.len());
}
fn make_eq_hashtable(vm: &mut VmOld, _args: &[Object]) -> Object {
    vm.gc.new_eq_hashtable()
}
fn make_eqv_hashtable(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "make-eqv-hashtable";
    panic!("{}({}) not implemented", name, args.len());
}
fn hashtable_set_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
...
fn hashtable_ref(_vm: &mut VmOld, args: &[Object]) -> Object {
...
fn hashtable_keys(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "hashtable-keys";
    panic!("{}({}) not implemented", name, args.len());
}
fn string_hash(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "string-hash";
    panic!("{}({}) not implemented", name, args.len());
}
fn eqv_hash(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "eqv-hash";
    panic!("{}({}) not implemented", name, args.len());
}
fn string_ci_hash(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "string-ci-hash";
    panic!("{}({}) not implemented", name, args.len());
}
fn symbol_hash(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "symbol-hash";
    panic!("{}({}) not implemented", name, args.len());
}
fn equal_hash(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "equal-hash";
    panic!("{}({}) not implemented", name, args.len());
}
fn eq_hashtable_copy(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "eq-hashtable-copy";
    panic!("{}({}) not implemented", name, args.len());
}
fn current_error_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "current-error-port";
    panic!("{}({}) not implemented", name, args.len());
}
fn values(vm: &mut VmOld, args: &[Object]) -> Object {
    vm.values(args)
}
fn vm_apply(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "vm/apply";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_pair(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pair?";
    panic!("{}({}) not implemented", name, args.len());
}
fn make_custom_binary_input_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "make-custom-binary-input-port";
    panic!("{}({}) not implemented", name, args.len());
}
fn make_custom_binary_output_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "make-custom-binary-output-port";
    panic!("{}({}) not implemented", name, args.len());
}
fn make_custom_textual_input_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "make-custom-textual-input-port";
    panic!("{}({}) not implemented", name, args.len());
}
fn make_custom_textual_output_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "make-custom-textual-output-port";
    panic!("{}({}) not implemented", name, args.len());
}
fn get_u8(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "get-u8";
    panic!("{}({}) not implemented", name, args.len());
}
fn put_u8(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "put-u8";
    panic!("{}({}) not implemented", name, args.len());
}
fn put_string(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "put-string";
    panic!("{}({}) not implemented", name, args.len());
}
fn flush_output_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flush-output-port";
    panic!("{}({}) not implemented", name, args.len());
}
fn output_port_buffer_mode(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "output-port-buffer-mode";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_u8_set_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-u8-set!";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_port_has_port_position(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "port-has-port-position?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_port_has_set_port_position_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "port-has-set-port-position!?";
    panic!("{}({}) not implemented", name, args.len());
}
fn port_position(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "port-position";
    panic!("{}({}) not implemented", name, args.len());
}
fn set_port_position_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "set-port-position!";
    panic!("{}({}) not implemented", name, args.len());
}
fn get_bytevector_n_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "get-bytevector-n!";
    panic!("{}({}) not implemented", name, args.len());
}
fn get_bytevector_some(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "get-bytevector-some";
    panic!("{}({}) not implemented", name, args.len());
}
fn get_bytevector_all(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "get-bytevector-all";
    panic!("{}({}) not implemented", name, args.len());
}
fn transcoded_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "transcoded-port";
    panic!("{}({}) not implemented", name, args.len());
}
fn latin_1_codec(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "latin-1-codec";
    panic!("{}({}) not implemented", name, args.len());
}
fn utf_8_codec(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "utf-8-codec";
    panic!("{}({}) not implemented", name, args.len());
}
fn utf_16_codec(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "utf-16-codec";
    panic!("{}({}) not implemented", name, args.len());
}
fn make_transcoder(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "make-transcoder";
    panic!("{}({}) not implemented", name, args.len());
}
fn eof_object(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "eof-object";
    panic!("{}({}) not implemented", name, args.len());
}
fn sys_open_bytevector_output_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "sys-open-bytevector-output-port";
    panic!("{}({}) not implemented", name, args.len());
}
fn sys_get_bytevector(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "sys-get-bytevector";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_length(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-length";
    panic!("{}({}) not implemented", name, args.len());
}
fn standard_input_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "standard-input-port";
    panic!("{}({}) not implemented", name, args.len());
}
fn standard_output_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "standard-output-port";
    panic!("{}({}) not implemented", name, args.len());
}
fn standard_error_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "standard-error-port";
    panic!("{}({}) not implemented", name, args.len());
}
fn get_bytevector_n(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "get-bytevector-n";
    panic!("{}({}) not implemented", name, args.len());
}
fn open_file_output_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "open-file-output-port";
    panic!("{}({}) not implemented", name, args.len());
}
fn open_file_input_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "open-file-input-port";
    panic!("{}({}) not implemented", name, args.len());
}
fn close_input_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "close-input-port";
    panic!("{}({}) not implemented", name, args.len());
}
fn vector(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "vector";
    panic!("{}({}) not implemented", name, args.len());
}
fn regexp_replace(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "regexp-replace";
    panic!("{}({}) not implemented", name, args.len());
}
fn regexp_replace_all(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "regexp-replace-all";
    panic!("{}({}) not implemented", name, args.len());
}
fn source_info(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "source-info";
    panic!("{}({}) not implemented", name, args.len());
}
fn eval(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "eval";
    panic!("{}({}) not implemented", name, args.len());
}
fn eval_compiled(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "eval-compiled";
    panic!("{}({}) not implemented", name, args.len());
}

// We make apply public so that Vm can access.
pub fn apply(_vm: &mut VmOld, _args: &[Object]) -> Object {
    let name: &str = "apply";
    panic!("{} should not be called. It is handled in call in vm", name);
}
fn assq(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "assq";
    check_argc!(name, args, 2);
    let key = args[0];
...
fn assoc(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "assoc";
    panic!("{}({}) not implemented", name, args.len());
}
fn assv(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "assv";
    panic!("{}({}) not implemented", name, args.len());
}
fn exit(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "exit";
    panic!("{}({}) not implemented", name, args.len());
}
fn macroexpand_1(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "macroexpand-1";
    panic!("{}({}) not implemented", name, args.len());
}
fn memv(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "memv";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_procedure(_vm: &mut VmOld, args: &[Object]) -> Object {
...
fn load(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "load";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_symbol(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "symbol?";
    check_argc!(name, args, 1);
    Object::make_bool(args[0].is_symbol())
}
fn is_charle(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "char<=?";
...
fn is_charlt(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "char<?";
    check_argc_at_least!(name, args, 2);
    for i in 0..args.len() {
        match args[i] {
...
fn is_charge(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "char>=?";
    check_argc_at_least!(name, args, 2);
    for i in 0..args.len() {
        match args[i] {
...
fn is_chargt(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "char>?";
    check_argc_at_least!(name, args, 2);
    for i in 0..args.len() {
        match args[i] {
...
fn read(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "read";
    panic!("{}({}) not implemented", name, args.len());
}
fn vector_to_list(vm: &mut VmOld, args: &[Object]) -> Object {
...
fn set_source_info_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "set-source-info!";
    panic!("{}({}) not implemented", name, args.len());
}
fn call_process(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%call-process";
    panic!("{}({}) not implemented", name, args.len());
}
fn confstr(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%confstr";
    panic!("{}({}) not implemented", name, args.len());
}
fn dup(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%dup";
    panic!("{}({}) not implemented", name, args.len());
}
fn start_process(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%start-process";
    panic!("{}({}) not implemented", name, args.len());
}
fn get_closure_name(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%get-closure-name";
    panic!("{}({}) not implemented", name, args.len());
}
fn append(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "append";
    panic!("{}({}) not implemented", name, args.len());
}
fn append2(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "append2";
    panic!("{}({}) not implemented", name, args.len());
}
fn append_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "append!";
    match args {
        &[] => Object::Nil,
        _ => {
...
fn pass3_find_free(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pass3/find-free";
    panic!("{}({}) not implemented", name, args.len());
}
fn pass3_find_sets(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pass3/find-sets";
    panic!("{}({}) not implemented", name, args.len());
}
fn pass4_fixup_labels(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pass4/fixup-labels";
    panic!("{}({}) not implemented", name, args.len());
}
fn make_code_builder(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "make-code-builder";
    println!("{}({}) not implemented", name, args.len());
    return Object::False;
}
fn code_builder_put_extra1_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "code-builder-put-extra1!";
    panic!("{}({}) not implemented", name, args.len());
}
fn code_builder_put_extra2_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "code-builder-put-extra2!";
    panic!("{}({}) not implemented", name, args.len());
}
fn code_builder_put_extra3_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "code-builder-put-extra3!";
    panic!("{}({}) not implemented", name, args.len());
}
fn code_builder_put_extra4_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "code-builder-put-extra4!";
    panic!("{}({}) not implemented", name, args.len());
}
fn code_builder_put_extra5_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "code-builder-put-extra5!";
    panic!("{}({}) not implemented", name, args.len());
}
fn code_builder_append_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "code-builder-append!";
    panic!("{}({}) not implemented", name, args.len());
}
fn code_builder_emit(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "code-builder-emit";
    panic!("{}({}) not implemented", name, args.len());
}
fn code_builder_put_insn_arg0_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "code-builder-put-insn-arg0!";
    panic!("{}({}) not implemented", name, args.len());
}
fn code_builder_put_insn_arg1_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "code-builder-put-insn-arg1!";
    println!("arg1={} {} {}", args[0], args[1], args[2]);
    panic!("{}({}) not implemented", name, args.len());
}
fn code_builder_put_insn_arg2_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "code-builder-put-insn-arg2!";
    panic!("{}({}) not implemented", name, args.len());
}
fn length(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "length";
    check_argc!(name, args, 1);
...
fn list_to_vector(vm: &mut VmOld, args: &[Object]) -> Object {
...
fn pass3_compile_refer(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pass3/compile-refer";
    panic!("{}({}) not implemented", name, args.len());
}
fn pass1_find_symbol_in_lvars(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pass1/find-symbol-in-lvars";
    panic!("{}({}) not implemented", name, args.len());
}
fn label(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "$label";
    panic!("{}({}) not implemented", name, args.len());
}
fn local_ref(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "$local-ref";
    panic!("{}({}) not implemented", name, args.len());
}
fn list_transposeadd(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "list-transpose+";
    panic!("{}({}) not implemented", name, args.len());
}
fn symbol_value(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "symbol-value";
    panic!("{}({}) not implemented", name, args.len());
}
fn set_symbol_value_destructive(vm: &mut VmOld, args: &[Object]) -> Object {
...
fn make_hashtable(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "make-hashtable";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_hashtable(_vm: &mut VmOld, args: &[Object]) -> Object {
...
fn hashtable_size(_vm: &mut VmOld, args: &[Object]) -> Object {
...
fn hashtable_delete_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
...
fn is_hashtable_contains(_vm: &mut VmOld, args: &[Object]) -> Object {
...
fn hashtable_copy(vm: &mut VmOld, args: &[Object]) -> Object {
...
fn is_hashtable_mutable(_vm: &mut VmOld, args: &[Object]) -> Object {
...
fn hashtable_clear_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
...
fn hashtable_equivalence_function(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "hashtable-equivalence-function";
    panic!("{}({}) not implemented", name, args.len());
}
fn hashtable_hash_function(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "hashtable-hash-function";
    panic!("{}({}) not implemented", name, args.len());
}
fn throw(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "throw";
    panic!("{}({}) not implemented", name, args.len());
}
fn number_lt(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "<";
    panic!("{}({}) not implemented", name, args.len());
}
fn number_le(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "<=";
    panic!("{}({}) not implemented", name, args.len());
}
fn number_gt(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = ">";
    panic!("{}({}) not implemented", name, args.len());
}
fn number_ge(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = ">=";
    panic!("{}({}) not implemented", name, args.len());
}
fn number_eq(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "=";
    panic!("{}({}) not implemented", name, args.len());
}
fn number_add(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "+";
    panic!("{}({}) not implemented", name, args.len());
}
fn nuber_sub(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "-";
    panic!("{}({}) not implemented", name, args.len());
}
fn number_mul(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "*";
    panic!("{}({}) not implemented", name, args.len());
}
fn number_div(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "/";
    panic!("{}({}) not implemented", name, args.len());
}
fn max(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "max";
    panic!("{}({}) not implemented", name, args.len());
}
fn min(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "min";
    panic!("{}({}) not implemented", name, args.len());
}
fn get_char(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "get-char";
    panic!("{}({}) not implemented", name, args.len());
}
fn lookahead_char(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "lookahead-char";
    panic!("{}({}) not implemented", name, args.len());
}
fn get_string_n(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "get-string-n";
    panic!("{}({}) not implemented", name, args.len());
}
fn get_string_n_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "get-string-n!";
    panic!("{}({}) not implemented", name, args.len());
}
fn get_string_all(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "get-string-all";
    panic!("{}({}) not implemented", name, args.len());
}
fn get_line(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "get-line";
    panic!("{}({}) not implemented", name, args.len());
}
fn get_datum(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "get-datum";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_bytevector(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector?";
    panic!("{}({}) not implemented", name, args.len());
}
fn current_directory(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "current-directory";
    panic!("{}({}) not implemented", name, args.len());
}
fn standard_library_path(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "standard-library-path";
    panic!("{}({}) not implemented", name, args.len());
}
fn native_endianness(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "native-endianness";
    panic!("{}({}) not implemented", name, args.len());
}
fn make_bytevector(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "make-bytevector";
    panic!("{}({}) not implemented", name, args.len());
}

fn is_bytevectorequal(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector=?";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_fill_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-fill!";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_copy_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-copy!";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_copy(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-copy";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_u8_ref(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-u8-ref";
    panic!("{}({}) not implemented", name, args.len());
}

fn bytevector_s8_ref(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-s8-ref";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_s8_set_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-s8-set!";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_to_u8_list(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector->u8-list";
    panic!("{}({}) not implemented", name, args.len());
}
fn u8_list_to_bytevector(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "u8-list->bytevector";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_u16_ref(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-u16-ref";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_s16_ref(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-s16-ref";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_u16_native_ref(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-u16-native-ref";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_s16_native_ref(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-s16-native-ref";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_u16_set_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-u16-set!";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_s16_set_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-s16-set!";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_u16_native_set_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-u16-native-set!";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_s16_native_set_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-s16-native-set!";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_u32_ref(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-u32-ref";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_s32_ref(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-s32-ref";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_u32_native_ref(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-u32-native-ref";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_s32_native_ref(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-s32-native-ref";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_u32_set_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-u32-set!";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_s32_set_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-s32-set!";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_u32_native_set_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-u32-native-set!";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_s32_native_set_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-s32-native-set!";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_u64_ref(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-u64-ref";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_s64_ref(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-s64-ref";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_u64_native_ref(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-u64-native-ref";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_s64_native_ref(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-s64-native-ref";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_u64_set_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-u64-set!";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_s64_set_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-s64-set!";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_u64_native_set_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-u64-native-set!";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_s64_native_set_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-s64-native-set!";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_to_string(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector->string";
    panic!("{}({}) not implemented", name, args.len());
}
fn string_to_bytevector(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "string->bytevector";
    panic!("{}({}) not implemented", name, args.len());
}
fn string_to_utf8(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "string->utf8";
    panic!("{}({}) not implemented", name, args.len());
}
fn utf8_to_string(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "utf8->string";
    panic!("{}({}) not implemented", name, args.len());
}
fn null_terminated_bytevector_to_string(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "null-terminated-bytevector->string";
    panic!("{}({}) not implemented", name, args.len());
}
fn null_terminated_utf8_to_string(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "null-terminated-utf8->string";
    panic!("{}({}) not implemented", name, args.len());
}
fn string_to_utf16(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "string->utf16";
    panic!("{}({}) not implemented", name, args.len());
}
fn string_to_utf32(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "string->utf32";
    panic!("{}({}) not implemented", name, args.len());
}
fn utf16_to_string(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "utf16->string";
    panic!("{}({}) not implemented", name, args.len());
}
fn utf32_to_string(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "utf32->string";
    panic!("{}({}) not implemented", name, args.len());
}
fn close_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "close-port";
    panic!("{}({}) not implemented", name, args.len());
}
fn make_instruction(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "make-instruction";
    panic!("{}({}) not implemented", name, args.len());
}
fn make_compiler_instruction(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "make-compiler-instruction";
    panic!("{}({}) not implemented", name, args.len());
}
fn fasl_write(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fasl-write";
    panic!("{}({}) not implemented", name, args.len());
}
fn fasl_read(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fasl-read";
    panic!("{}({}) not implemented", name, args.len());
}

fn is_rational(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "rational?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_flonum(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flonum?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_fixnum(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fixnum?";
    check_argc!(name, args, 1);
    Object::make_bool(args[0].is_number())
}
fn is_bignum(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bignum?";
    panic!("{}({}) not implemented", name, args.len());
}
fn fixnum_width(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fixnum-width";
    panic!("{}({}) not implemented", name, args.len());
}
fn least_fixnum(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "greatest-fixnum";
    check_argc!(name, args, 0);
    Object::Number(-(2_isize.pow(62)))
}
fn greatest_fixnum(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "greatest-fixnum";
    check_argc!(name, args, 0);
    Object::Number(2_isize.pow(62) - 1)
}
fn make_rectangular(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "make-rectangular";
    panic!("{}({}) not implemented", name, args.len());
}
fn real_part(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "real-part";
    panic!("{}({}) not implemented", name, args.len());
}
fn imag_part(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "imag-part";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_exact(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "exact?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_inexact(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "inexact?";
    panic!("{}({}) not implemented", name, args.len());
}
fn exact(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "exact";
    panic!("{}({}) not implemented", name, args.len());
}
fn inexact(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "inexact";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_nan(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "nan?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_infinite(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "infinite?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_finite(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "finite?";
    panic!("{}({}) not implemented", name, args.len());
}
fn real_to_flonum(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "real->flonum";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_flequal(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fl=?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_fllt(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fl<?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_flgt(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fl>?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_flge(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fl>=?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_flle(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fl<=?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_flinteger(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flinteger?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_flzero(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flzero?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_flpositive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flpositive?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_flnegative(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flnegative?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_flodd(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flodd?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_fleven(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fleven?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_flfinite(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flfinite?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_flinfinite(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flinfinite?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_flnan(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flnan?";
    panic!("{}({}) not implemented", name, args.len());
}
fn flmax(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flmax";
    panic!("{}({}) not implemented", name, args.len());
}
fn flmin(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flmin";
    panic!("{}({}) not implemented", name, args.len());
}
fn fladd(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fl+";
    panic!("{}({}) not implemented", name, args.len());
}
fn flmul(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fl*";
    panic!("{}({}) not implemented", name, args.len());
}
fn flsub(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fl-";
    panic!("{}({}) not implemented", name, args.len());
}
fn fldiv_op(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fl/";
    panic!("{}({}) not implemented", name, args.len());
}
fn flabs(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flabs";
    panic!("{}({}) not implemented", name, args.len());
}
fn fldiv(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fldiv";
    panic!("{}({}) not implemented", name, args.len());
}
fn flmod(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flmod";
    panic!("{}({}) not implemented", name, args.len());
}
fn fldiv0(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fldiv0";
    panic!("{}({}) not implemented", name, args.len());
}
fn flmod0(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flmod0";
    panic!("{}({}) not implemented", name, args.len());
}
fn flnumerator(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flnumerator";
    panic!("{}({}) not implemented", name, args.len());
}
fn fldenominator(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fldenominator";
    panic!("{}({}) not implemented", name, args.len());
}
fn flfloor(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flfloor";
    panic!("{}({}) not implemented", name, args.len());
}
fn flceiling(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flceiling";
    panic!("{}({}) not implemented", name, args.len());
}
fn fltruncate(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fltruncate";
    panic!("{}({}) not implemented", name, args.len());
}
fn flround(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flround";
    panic!("{}({}) not implemented", name, args.len());
}
fn flexp(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flexp";
    panic!("{}({}) not implemented", name, args.len());
}
fn fllog(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fllog";
    panic!("{}({}) not implemented", name, args.len());
}
fn flsin(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flsin";
    panic!("{}({}) not implemented", name, args.len());
}
fn flcos(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flcos";
    panic!("{}({}) not implemented", name, args.len());
}
fn fltan(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fltan";
    panic!("{}({}) not implemented", name, args.len());
}
fn flasin(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flasin";
    panic!("{}({}) not implemented", name, args.len());
}
fn flacos(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flacos";
    panic!("{}({}) not implemented", name, args.len());
}
fn flatan(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flatan";
    panic!("{}({}) not implemented", name, args.len());
}
fn flsqrt(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flsqrt";
    panic!("{}({}) not implemented", name, args.len());
}
fn flexpt(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "flexpt";
    panic!("{}({}) not implemented", name, args.len());
}
fn fixnum_to_flonum(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fixnum->flonum";
    panic!("{}({}) not implemented", name, args.len());
}
fn bitwise_not(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bitwise-not";
    panic!("{}({}) not implemented", name, args.len());
}
fn bitwise_and(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bitwise-and";
    panic!("{}({}) not implemented", name, args.len());
}
fn bitwise_ior(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bitwise-ior";
    panic!("{}({}) not implemented", name, args.len());
}
fn bitwise_xor(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bitwise-xor";
    panic!("{}({}) not implemented", name, args.len());
}
fn bitwise_bit_count(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bitwise-bit-count";
    panic!("{}({}) not implemented", name, args.len());
}
fn bitwise_length(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bitwise-length";
    panic!("{}({}) not implemented", name, args.len());
}
fn bitwise_first_bit_set(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bitwise-first-bit-set";
    panic!("{}({}) not implemented", name, args.len());
}
fn bitwise_arithmetic_shift_left(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bitwise-arithmetic-shift-left";
    panic!("{}({}) not implemented", name, args.len());
}
fn bitwise_arithmetic_shift_right(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bitwise-arithmetic-shift-right";
    panic!("{}({}) not implemented", name, args.len());
}
fn bitwise_arithmetic_shift(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bitwise-arithmetic-shift";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_complex(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "complex?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_real(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "real?";
    panic!("{}({}) not implemented", name, args.len());
}

fn is_integer(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "integer?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_real_valued(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "real-valued?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_rational_valued(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "rational-valued?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_integer_valued(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "integer-valued?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_fxequal(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fx=?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_fxgt(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fx>?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_fxlt(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fx<?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_fxge(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fx>=?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_fxle(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fx<=?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_fxzero(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxzero?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_fxpositive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxpositive?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_fxnegative(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxnegative?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_fxodd(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxodd?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_fxeven(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxeven?";
    panic!("{}({}) not implemented", name, args.len());
}
fn fxmax(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxmax";
    panic!("{}({}) not implemented", name, args.len());
}
fn fxmin(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxmin";
    panic!("{}({}) not implemented", name, args.len());
}
fn fxadd(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fx+";
    panic!("{}({}) not implemented", name, args.len());
}
fn fxmul(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fx*";
    panic!("{}({}) not implemented", name, args.len());
}
fn fxsub(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fx-";
    panic!("{}({}) not implemented", name, args.len());
}
fn fxdiv(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxdiv";
    panic!("{}({}) not implemented", name, args.len());
}
fn fxmod(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxmod";
    panic!("{}({}) not implemented", name, args.len());
}
fn fxdiv0(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxdiv0";
    panic!("{}({}) not implemented", name, args.len());
}
fn fxmod0(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxmod0";
    panic!("{}({}) not implemented", name, args.len());
}
fn fxnot(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxnot";
    panic!("{}({}) not implemented", name, args.len());
}
fn fxand(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxand";
    panic!("{}({}) not implemented", name, args.len());
}
fn fxior(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxior";
    panic!("{}({}) not implemented", name, args.len());
}
fn fxxor(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxxor";
    panic!("{}({}) not implemented", name, args.len());
}
fn fxif(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxif";
    panic!("{}({}) not implemented", name, args.len());
}
fn fxbit_count(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxbit-count";
    panic!("{}({}) not implemented", name, args.len());
}
fn fxlength(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxlength";
    panic!("{}({}) not implemented", name, args.len());
}
fn fxfirst_bit_set(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxfirst-bit-set";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_fxbit_set(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxbit-set?";
    panic!("{}({}) not implemented", name, args.len());
}
fn fxcopy_bit(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxcopy-bit";
    panic!("{}({}) not implemented", name, args.len());
}
fn fxbit_field(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxbit-field";
    panic!("{}({}) not implemented", name, args.len());
}
fn fxcopy_bit_field(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxcopy-bit-field";
    panic!("{}({}) not implemented", name, args.len());
}
fn fxarithmetic_shift(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxarithmetic-shift";
    panic!("{}({}) not implemented", name, args.len());
}
fn fxarithmetic_shift_left(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxarithmetic-shift-left";
    panic!("{}({}) not implemented", name, args.len());
}
fn fxarithmetic_shift_right(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxarithmetic-shift-right";
    panic!("{}({}) not implemented", name, args.len());
}
fn fxrotate_bit_field(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxrotate-bit-field";
    panic!("{}({}) not implemented", name, args.len());
}
fn fxreverse_bit_field(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fxreverse-bit-field";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_ieee_single_native_ref(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-ieee-single-native-ref";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_ieee_single_ref(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-ieee-single-ref";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_ieee_double_native_ref(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-ieee-double-native-ref";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_ieee_double_ref(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-ieee-double-ref";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_ieee_single_native_set_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-ieee-single-native-set!";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_ieee_single_set_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-ieee-single-set!";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_ieee_double_native_set_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-ieee-double-native-set!";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_ieee_double_set_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-ieee-double-set!";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_even(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "even?";
    check_argc!(name, args, 1);
    match args[0] {
...
fn is_odd(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "odd?";
    panic!("{}({}) not implemented", name, args.len());
}
fn abs(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "abs";
    check_argc!(name, args, 1);
    match args[0] {
...
fn div(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "div";
    check_argc!(name, args, 2);
    match args {
...
fn div0(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "div0";
    panic!("{}({}) not implemented", name, args.len());
}
fn numerator(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "numerator";
    panic!("{}({}) not implemented", name, args.len());
}
fn denominator(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "denominator";
    panic!("{}({}) not implemented", name, args.len());
}
fn floor(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "floor";
    panic!("{}({}) not implemented", name, args.len());
}
fn ceiling(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "ceiling";
    panic!("{}({}) not implemented", name, args.len());
}
fn truncate(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "truncate";
    panic!("{}({}) not implemented", name, args.len());
}
fn round(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "round";
    panic!("{}({}) not implemented", name, args.len());
}
fn exp(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "exp";
    panic!("{}({}) not implemented", name, args.len());
}
fn log(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "log";
    panic!("{}({}) not implemented", name, args.len());
}
fn sin(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "sin";
    panic!("{}({}) not implemented", name, args.len());
}
fn cos(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "cos";
    panic!("{}({}) not implemented", name, args.len());
}
fn tan(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "tan";
    panic!("{}({}) not implemented", name, args.len());
}
fn asin(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "asin";
    panic!("{}({}) not implemented", name, args.len());
}
fn acos(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "acos";
    panic!("{}({}) not implemented", name, args.len());
}
fn sqrt(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "sqrt";
    panic!("{}({}) not implemented", name, args.len());
}
fn magnitude(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "magnitude";
    panic!("{}({}) not implemented", name, args.len());
}
fn angle(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "angle";
    panic!("{}({}) not implemented", name, args.len());
}
fn atan(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "atan";
    panic!("{}({}) not implemented", name, args.len());
}
fn expt(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "expt";
    panic!("{}({}) not implemented", name, args.len());
}
fn make_polar(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "make-polar";
    panic!("{}({}) not implemented", name, args.len());
}
fn string_copy(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "string-copy";
    panic!("{}({}) not implemented", name, args.len());
}
fn vector_fill_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "vector-fill!";
    panic!("{}({}) not implemented", name, args.len());
}
fn ungensym(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "ungensym";
    panic!("{}({}) not implemented", name, args.len());
}
fn disasm(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "disasm";
    panic!("{}({}) not implemented", name, args.len());
}
fn print_stack(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "print-stack";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_fast_equal(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "fast-equal?";
    panic!("{}({}) not implemented", name, args.len());
}
fn native_eol_style(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "native-eol-style";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_buffer_mode(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "buffer-mode?";
    panic!("{}({}) not implemented", name, args.len());
}
fn microseconds(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "microseconds";
    panic!("{}({}) not implemented", name, args.len());
}
fn local_tz_offset(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "local-tz-offset";
    panic!("{}({}) not implemented", name, args.len());
}
fn fork(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%fork";
    panic!("{}({}) not implemented", name, args.len());
}
fn exec(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%exec";
    panic!("{}({}) not implemented", name, args.len());
}
fn waitpid(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%waitpid";
    panic!("{}({}) not implemented", name, args.len());
}
fn pipe(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%pipe";
    panic!("{}({}) not implemented", name, args.len());
}
fn getpid(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%getpid";
    panic!("{}({}) not implemented", name, args.len());
}
fn set_current_directory_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "set-current-directory!";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_binary_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "binary-port?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_input_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "input-port?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_port_eof(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "port-eof?";
    panic!("{}({}) not implemented", name, args.len());
}
fn lookahead_u8(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "lookahead-u8";
    panic!("{}({}) not implemented", name, args.len());
}
fn open_bytevector_input_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "open-bytevector-input-port";
    panic!("{}({}) not implemented", name, args.len());
}
fn ffi_open(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%ffi-open";
    panic!("{}({}) not implemented", name, args.len());
}
fn ffi_lookup(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%ffi-lookup";
    panic!("{}({}) not implemented", name, args.len());
}
fn ffi_call(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%ffi-call";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_ffi_supported(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%ffi-supported?";
    panic!("{}({}) not implemented", name, args.len());
}
fn ffi_malloc(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%ffi-malloc";
    panic!("{}({}) not implemented", name, args.len());
}
fn ffi_free(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%ffi-free";
    panic!("{}({}) not implemented", name, args.len());
}
fn ffi_make_c_callback_trampoline(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%ffi-make-c-callback-trampoline";
    panic!("{}({}) not implemented", name, args.len());
}
fn ffi_free_c_callback_trampoline(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%ffi-free-c-callback-trampoline";
    panic!("{}({}) not implemented", name, args.len());
}
fn ffi_close(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%ffi-close";
    panic!("{}({}) not implemented", name, args.len());
}
fn ffi_error(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%ffi-error";
    panic!("{}({}) not implemented", name, args.len());
}
fn host_os(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "host-os";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_output_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "output-port?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_textual_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "textual-port?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "port?";
    panic!("{}({}) not implemented", name, args.len());
}
fn port_transcoder(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "port-transcoder";
    panic!("{}({}) not implemented", name, args.len());
}
fn native_transcoder(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "native-transcoder";
    panic!("{}({}) not implemented", name, args.len());
}
fn put_bytevector(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "put-bytevector";
    panic!("{}({}) not implemented", name, args.len());
}
fn put_char(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "put-char";
    panic!("{}({}) not implemented", name, args.len());
}
fn write_char(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "write-char";
    panic!("{}({}) not implemented", name, args.len());
}
fn transcoder_codec(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "transcoder-codec";
    panic!("{}({}) not implemented", name, args.len());
}
fn transcoder_eol_style(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "transcoder-eol-style";
    panic!("{}({}) not implemented", name, args.len());
}
fn transcoder_error_handling_mode(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "transcoder-error-handling-mode";
    panic!("{}({}) not implemented", name, args.len());
}
fn quotient(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "quotient";
    panic!("{}({}) not implemented", name, args.len());
}
fn remainder(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "remainder";
    panic!("{}({}) not implemented", name, args.len());
}
fn modulo(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "modulo";
    panic!("{}({}) not implemented", name, args.len());
}
fn open_file_input_output_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "open-file-input/output-port";
    panic!("{}({}) not implemented", name, args.len());
}
fn make_custom_binary_input_output_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "make-custom-binary-input/output-port";
    panic!("{}({}) not implemented", name, args.len());
}
fn make_custom_textual_input_output_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "make-custom-textual-input/output-port";
    panic!("{}({}) not implemented", name, args.len());
}
fn put_datum(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "put-datum";
    panic!("{}({}) not implemented", name, args.len());
}
fn list_ref(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "list-ref";
    panic!("{}({}) not implemented", name, args.len());
}
fn list_tail(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "list-tail";
    panic!("{}({}) not implemented", name, args.len());
}
fn time_usage(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "time-usage";
    panic!("{}({}) not implemented", name, args.len());
}
fn mosh_executable_path(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "mosh-executable-path";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_socket(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "socket?";
    panic!("{}({}) not implemented", name, args.len());
}
fn socket_accept(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "socket-accept";
    panic!("{}({}) not implemented", name, args.len());
}
fn make_client_socket(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "make-client-socket";
    panic!("{}({}) not implemented", name, args.len());
}
fn make_server_socket(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "make-server-socket";
    panic!("{}({}) not implemented", name, args.len());
}
fn os_constant(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "os-constant";
    panic!("{}({}) not implemented", name, args.len());
}
fn socket_recv(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "socket-recv";
    panic!("{}({}) not implemented", name, args.len());
}
fn socket_recv_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "socket-recv!";
    panic!("{}({}) not implemented", name, args.len());
}
fn socket_send(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "socket-send";
    panic!("{}({}) not implemented", name, args.len());
}
fn socket_close(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "socket-close";
    panic!("{}({}) not implemented", name, args.len());
}
fn socket_shutdown(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "socket-shutdown";
    panic!("{}({}) not implemented", name, args.len());
}
fn socket_port(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "socket-port";
    panic!("{}({}) not implemented", name, args.len());
}
fn make_vm(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "make-vm";
    panic!("{}({}) not implemented", name, args.len());
}
fn vm_start_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "vm-start!";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_vm(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "vm?";
    panic!("{}({}) not implemented", name, args.len());
}
fn vm_set_value_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "vm-set-value!";
    panic!("{}({}) not implemented", name, args.len());
}
fn vm_join_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "vm-join!";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_main_vm(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "main-vm?";
    panic!("{}({}) not implemented", name, args.len());
}
fn vm_self(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "vm-self";
    panic!("{}({}) not implemented", name, args.len());
}
fn register(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "register";
    panic!("{}({}) not implemented", name, args.len());
}
fn whereis(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "whereis";
    panic!("{}({}) not implemented", name, args.len());
}
fn make_condition_variable(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "make-condition-variable";
    panic!("{}({}) not implemented", name, args.len());
}
fn condition_variable_wait_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "condition-variable-wait!";
    panic!("{}({}) not implemented", name, args.len());
}
fn condition_variable_notify_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "condition-variable-notify!";
    panic!("{}({}) not implemented", name, args.len());
}
fn condition_variable_notify_all_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "condition-variable-notify-all!";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_mutex(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "mutex?";
    panic!("{}({}) not implemented", name, args.len());
}
fn make_mutex(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "make-mutex";
    panic!("{}({}) not implemented", name, args.len());
}
fn mutex_lock_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "mutex-lock!";
    panic!("{}({}) not implemented", name, args.len());
}
fn mutex_try_lock_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "mutex-try-lock!";
    panic!("{}({}) not implemented", name, args.len());
}
fn mutex_unlock_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "mutex-unlock!";
    panic!("{}({}) not implemented", name, args.len());
}
fn make_vector(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "make-vector";
    panic!("{}({}) not implemented", name, args.len());
}
fn vector_length(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "vector-length";
    panic!("{}({}) not implemented", name, args.len());
}
fn vector_ref(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "vector-ref";
    panic!("{}({}) not implemented", name, args.len());
}
fn vector_set_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "vector-set!";
    panic!("{}({}) not implemented", name, args.len());
}
fn create_directory(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "create-directory";
    panic!("{}({}) not implemented", name, args.len());
}
fn delete_directory(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "delete-directory";
    panic!("{}({}) not implemented", name, args.len());
}
fn rename_file(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "rename-file";
    panic!("{}({}) not implemented", name, args.len());
}
fn create_symbolic_link(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "create-symbolic-link";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_file_directory(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "file-directory?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_file_symbolic_link(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "file-symbolic-link?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_file_regular(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "file-regular?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_file_readable(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "file-readable?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_file_executable(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "file-executable?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_file_writable(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "file-writable?";
    panic!("{}({}) not implemented", name, args.len());
}
fn file_size_in_bytes(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "file-size-in-bytes";
    panic!("{}({}) not implemented", name, args.len());
}
fn file_stat_mtime(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "file-stat-mtime";
    panic!("{}({}) not implemented", name, args.len());
}
fn file_stat_atime(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "file-stat-atime";
    panic!("{}({}) not implemented", name, args.len());
}
fn file_stat_ctime(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "file-stat-ctime";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_pointer(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer?";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_to_integer(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer->integer";
    panic!("{}({}) not implemented", name, args.len());
}
fn integer_to_pointer(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "integer->pointer";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_ref_c_uint8(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-ref-c-uint8";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_ref_c_uint16(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-ref-c-uint16";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_ref_c_uint32(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-ref-c-uint32";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_ref_c_uint64(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-ref-c-uint64";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_ref_c_int8(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-ref-c-int8";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_ref_c_int16(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-ref-c-int16";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_ref_c_int32(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-ref-c-int32";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_ref_c_int64(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-ref-c-int64";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_ref_c_signed_char(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-ref-c-signed-char";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_ref_c_unsigned_char(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-ref-c-unsigned-char";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_ref_c_signed_short(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-ref-c-signed-short";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_ref_c_unsigned_short(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-ref-c-unsigned-short";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_ref_c_signed_int(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-ref-c-signed-int";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_ref_c_unsigned_int(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-ref-c-unsigned-int";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_ref_c_signed_long(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-ref-c-signed-long";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_ref_c_unsigned_long(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-ref-c-unsigned-long";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_ref_c_signed_long_long(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-ref-c-signed-long-long";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_ref_c_unsigned_long_long(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-ref-c-unsigned-long-long";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_ref_c_float(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-ref-c-float";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_ref_c_double(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-ref-c-double";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_ref_c_pointer(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-ref-c-pointer";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_set_c_int8_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-set-c-int8!";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_set_c_int16_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-set-c-int16!";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_set_c_int32_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-set-c-int32!";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_set_c_int64_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-set-c-int64!";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_set_c_uint8_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-set-c-uint8!";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_set_c_uint16_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-set-c-uint16!";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_set_c_uint32_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-set-c-uint32!";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_set_c_uint64_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-set-c-uint64!";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_set_c_char_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-set-c-char!";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_set_c_short_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-set-c-short!";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_set_c_int_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-set-c-int!";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_set_c_long_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-set-c-long!";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_set_c_long_long_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-set-c-long-long!";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_set_c_float_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-set-c-float!";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_set_c_double_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-set-c-double!";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_set_c_pointer_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-set-c-pointer!";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_copy_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer-copy!";
    panic!("{}({}) not implemented", name, args.len());
}
fn bytevector_pointer(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "bytevector-pointer";
    panic!("{}({}) not implemented", name, args.len());
}
fn shared_errno(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "shared-errno";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_simple_struct(_vm: &mut VmOld, args: &[Object]) -> Object {
...
fn make_simple_struct(vm: &mut VmOld, args: &[Object]) -> Object {
...
fn simple_struct_ref(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "simple-struct-ref";
    panic!("{}({}) not implemented", name, args.len());
}
fn simple_struct_set_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "simple-struct-set!";
    panic!("{}({}) not implemented", name, args.len());
}
fn simple_struct_name(_vm: &mut VmOld, args: &[Object]) -> Object {
...
fn lookup_nongenerative_rtd(vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "lookup-nongenerative-rtd";
    check_argc!(name, args, 1);
    vm.lookup_rtd(args[0])
}
fn nongenerative_rtd_set_destructive(vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "nongenerative-rtd-set!";
    check_argc!(name, args, 2);
    vm.set_rtd(args[0], args[1]);
    Object::Unspecified
}
fn is_same_marksmul(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "same-marks*?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_same_marks(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "same-marks?";
    panic!("{}({}) not implemented", name, args.len());
}
fn id_to_real_label(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "id->real-label";
    panic!("{}({}) not implemented", name, args.len());
}
fn join_wraps(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "join-wraps";
    panic!("{}({}) not implemented", name, args.len());
}
fn gensym_prefix_set_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "gensym-prefix-set!";
    panic!("{}({}) not implemented", name, args.len());
}
fn current_dynamic_winders(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "current-dynamic-winders";
    panic!("{}({}) not implemented", name, args.len());
}
fn sexp_map(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "sexp-map";
    panic!("{}({}) not implemented", name, args.len());
}
fn sexp_map_debug(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "sexp-map/debug";
    panic!("{}({}) not implemented", name, args.len());
}
fn write_ss(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "write/ss";
    panic!("{}({}) not implemented", name, args.len());
}
fn monapi_message_send(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%monapi-message-send";
    panic!("{}({}) not implemented", name, args.len());
}
fn monapi_name_whereis(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%monapi-name-whereis";
    panic!("{}({}) not implemented", name, args.len());
}
fn monapi_message_receive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%monapi-message-receive";
    panic!("{}({}) not implemented", name, args.len());
}
fn monapi_name_add_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%monapi-name-add!";
    panic!("{}({}) not implemented", name, args.len());
}
fn monapi_message_send_receive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%monapi-message-send-receive";
    panic!("{}({}) not implemented", name, args.len());
}
fn monapi_message_reply(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%monapi-message-reply";
    panic!("{}({}) not implemented", name, args.len());
}
fn monapi_make_stream(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%monapi-make-stream";
    panic!("{}({}) not implemented", name, args.len());
}
fn monapi_stream_handle(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%monapi-stream-handle";
    panic!("{}({}) not implemented", name, args.len());
}
fn monapi_stream_write(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%monapi-stream-write";
    panic!("{}({}) not implemented", name, args.len());
}
fn monapi_stream_read(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "%monapi-stream-read";
    panic!("{}({}) not implemented", name, args.len());
}
fn process_list(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "process-list";
    panic!("{}({}) not implemented", name, args.len());
}
fn process_terminate_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "process-terminate!";
    panic!("{}({}) not implemented", name, args.len());
}
fn socket_sslize_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "socket-sslize!";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_ssl_socket(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "ssl-socket?";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_ssl_supported(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "ssl-supported?";
    panic!("{}({}) not implemented", name, args.len());
}
fn file_to_string(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "file->string";
    panic!("{}({}) not implemented", name, args.len());
}
fn annotated_cons(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "annotated-cons";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_annotated_pair(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "annotated-pair?";
    panic!("{}({}) not implemented", name, args.len());
}
fn get_annotation(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "get-annotation";
    panic!("{}({}) not implemented", name, args.len());
}
fn set_annotation_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "set-annotation!";
    panic!("{}({}) not implemented", name, args.len());
}
fn pointer_to_object(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "pointer->object";
    panic!("{}({}) not implemented", name, args.len());
}
fn object_to_pointer(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "object->pointer";
    panic!("{}({}) not implemented", name, args.len());
}
fn set_current_error_port_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "set-current-error-port!";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_port_open(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "port-open?";
    panic!("{}({}) not implemented", name, args.len());
}
fn make_f64array(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "make-f64array";
    panic!("{}({}) not implemented", name, args.len());
}
fn is_f64array(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "f64array?";
    panic!("{}({}) not implemented", name, args.len());
}
fn f64array_ref(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "f64array-ref";
    panic!("{}({}) not implemented", name, args.len());
}
fn f64array_set_destructive(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "f64array-set!";
    panic!("{}({}) not implemented", name, args.len());
}
fn f64array_shape(_vm: &mut VmOld, args: &[Object]) -> Object {
    let name: &str = "f64array-shape";
    panic!("{}({}) not implemented", name, args.len());
}
fn f64array_dot_product(_vm: &mut VmOld, args: &[Object]) -> Object {
