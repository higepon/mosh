...
// (match '(0 (1 2) (3 4 5)) ((a (b c) (d e f)) (list a b c d e f)))
#[test]
fn test384_optimized() {
    let mut vm = Vm::new();
    ...
    let list2 = vm
        .gc
        .listn(&[Object::Number(3), Object::Number(4), Object::Number(5)]);
    let list3 = vm.gc.listn(&[Object::Number(0), list1, list2]);
    ...
    let ops = vec![
        ...
        Op::Frame(20),
        Op::Frame(8),
        Op::ReferGlobalPush(vm.gc.intern("a")),
        Op::ReferGlobalPush(vm.gc.intern("b")),
        Op::ReferGlobalPush(vm.gc.intern("c")),
        Op::ReferGlobalPush(vm.gc.intern("d")),
        Op::ReferGlobalPush(vm.gc.intern("e")),
        Op::ReferGlobalPush(vm.gc.intern("f")),
        Op::ReferFreeCall(89, 6),
        Op::PushFrame(10),
        Op::Frame(3),
        Op::ReferGlobalPush(vm.gc.intern("c")),
        Op::ReferGlobalCall(vm.gc.intern("b"), 1),
        Op::PushFrame(4),
        Op::ReferGlobalPush(vm.gc.intern("e")),
        Op::ReferGlobalPush(vm.gc.intern("f")),
        Op::ReferGlobalCall(vm.gc.intern("d"), 2),
        Op::Push,
        Op::ReferGlobalCall(vm.gc.intern("a"), 2),
        Op::Call(1),
        Op::Push,
        Op::ReferGlobalCall(vm.gc.intern("match"), 2),
        Op::Halt,
        Op::Nop,
        Op::Nop,
        Op::Nop,
...
// (match 123 ((? string? x) (list 'string x)) ((? number? x) (list 'number x)))
#[test]
fn test385_optimized() {
    let mut vm = Vm::new();

    let sym0 = vm.gc.symbol_intern("number");
    let sym1 = vm.gc.symbol_intern("string");
    let list0 = vm.gc.listn(&[sym0, Object::Number(123)]);
    ...
    let ops = vec![
        ...
        Op::Frame(4),
        Op::ConstantPush(sym1),
        Op::ReferGlobalPush(vm.gc.intern("x")),
        Op::ReferFreeCall(89, 2),
        Op::PushFrame(4),
        Op::ReferFreePush(31),
        Op::ReferGlobalPush(vm.gc.intern("x")),
        Op::ReferGlobalCall(vm.gc.intern("?"), 2),
        Op::Call(1),
        Op::PushFrame(10),
        Op::Frame(4),
        Op::ConstantPush(sym0),
        ...
        Op::Call(1),
        Op::Push,
        Op::ReferGlobalCall(vm.gc.intern("match"), 3),
        Op::Halt,
        Op::Nop,
        Op::Nop,
        Op::Nop,
...
// (match '(the answer is 42) (`(the answer is ,value) value) (else #f))
#[test]
fn test386_optimized() {
    let mut vm = Vm::new();

    let sym0 = vm.gc.symbol_intern("the");
    let sym1 = vm.gc.symbol_intern("answer");
    let sym2 = vm.gc.symbol_intern("is");
    let list0 = vm.gc.listn(&[sym0, sym1, sym2, Object::Number(42)]);

    let ops = vec![
        Op::Frame(19),
        Op::ConstantPush(list0),
        Op::Frame(12),
        Op::ReferGlobalPush(vm.gc.intern("value")),
        Op::ConstantPush(sym0),
        Op::ConstantPush(sym1),
        Op::ConstantPush(sym2),
        Op::ReferGlobalPush(vm.gc.intern("value")),
...
// (match '(the answer was 42) (`(the answer is ,value) value) (else #f))
#[test]
fn test387_optimized() {
    let mut vm = Vm::new();

    let sym0 = vm.gc.symbol_intern("the");
    let sym1 = vm.gc.symbol_intern("answer");
    let sym2 = vm.gc.symbol_intern("was");
    let sym3 = vm.gc.symbol_intern("is");
    let list0 = vm.gc.listn(&[sym0, sym1, sym2, Object::Number(42)]);
...
// (match '(a b c d) ((the answer is value) value) (else #f))
#[test]
fn test388_optimized() {
    let mut vm = Vm::new();

    let sym0 = vm.gc.symbol_intern("d");
    let sym1 = vm.gc.symbol_intern("a");
    let sym2 = vm.gc.symbol_intern("b");
    let sym3 = vm.gc.symbol_intern("c");
    let list0 = vm.gc.listn(&[sym1, sym2, sym3, sym0]);
    ...
    let ops = vec![
        ...
        Op::ReferGlobalPush(vm.gc.intern("value")),
        Op::Frame(5),
        Op::ReferGlobalPush(vm.gc.intern("answer")),
        Op::ReferGlobalPush(vm.gc.intern("is")),
        Op::ReferGlobalPush(vm.gc.intern("value")),
        Op::ReferGlobalCall(vm.gc.intern("the"), 3),
        Op::Call(1),
        Op::PushFrame(3),
        Op::ConstantPush(Object::False),
        Op::ReferGlobalCall(vm.gc.intern("else"), 1),
