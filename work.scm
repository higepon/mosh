...
;; ;;     (lambda ()
;; ;;       (div (microseconds) 1000000)))


;; ;;   (define tm:local-tz-offset
;; ;;     (lambda ()
;; ;;       (- (current-seconds) (utc-seconds))))
...
;; ;; ;(display (local-tz-offset))
;; ;;   (define current-seconds
;; ;;     (lambda ()
;; ;;       (div (microseconds) 1000000)))


;; ;; (format #t "microseconds=~d current-seconds=~d\n" (microseconds) (current-seconds))
;; ;; ;; (newline)
;; ;; ;; (display (current-seconds))
;; ;; (display (date->string (current-date) "~D"))
