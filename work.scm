(define (code-builder-put3! a b c d)
  '())
...
;; (print 'Hige)
;; ;(lambda () (code-builder-put3))
;; ;; (code-builder-put3! (make-code-builder) 'hage 'hige 'hoge)
;; ;; (let1 cb (make-code-builder)
;; ;;   (let loop ([i 0])
;; ;;     (code-builder-put2! cb 'a 'b 'c)
;; ;;     (loop (+ i 1))))

;; (let1 cb (make-code-builder)
;;   (letrec ([loop (lambda ()
;;                    (code-builder-put2! cb)
;;                    (loop))])
;;     (loop)))
