...
;;     (test2 ,(lambda e (error "test2")))
    ...
    (native-endianness ,(lambda e "not implemented"))
    (make-bytevector ,(lambda e "not implemented"))
    (make-bytevector ,(lambda e "not implemented"))
    (bytevector-length ,(lambda e "not implemented"))
    (bytevector=? ,(lambda e "not implemented"))
    ...
    (bytevector-u16-ref ,(lambda e "not implemented"))
    (bytevector-s16-ref ,(lambda e "not implemented"))
    (bytevector-u16-native-ref ,(lambda e "not implemented"))
    (bytevector-s16-native-ref ,(lambda e "not implemented"))
    (bytevector-u16-set! ,(lambda e "not implemented"))
    ...
    (bytevector-u64-ref ,(lambda e "not implemented"))
    (bytevector-s64-ref ,(lambda e "not implemented"))
    (bytevector-u64-native-ref ,(lambda e "not implemented"))
    (bytevector-s64-native-ref ,(lambda e "not implemented"))
    (bytevector-u64-set! ,(lambda e "not implemented"))
