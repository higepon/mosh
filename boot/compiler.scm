...
(define (fetch-instructions)
  '((COMPILE_ERROR .  3)
    ...
    (REFER_FREE_PUSH .  1)
    (REFER_LOCAL_PUSH .  1)
    (REFER_LOCAL_PUSH_CONSTANT .  2)
    (REFER_LOCAL_PUSH_CONSTANT_BRANCH_NOT_LE .  3)
    (REFER_LOCAL_PUSH_CONSTANT_BRANCH_NOT_GE .  3)
    (REFER_LOCAL_PUSH_CONSTANT_BRANCH_NOT_NUMBER_EQUAL .  3)
    (REFER_LOCAL_BRANCH_NOT_NULL .  2)
    (REFER_LOCAL_BRANCH_NOT_LT .  2)
    (REFER_FREE_CALL .  2)
    (REFER_GLOBAL_PUSH .  1)
    (REFER_LOCAL_CALL .  2)
    (LOCAL_CALL .  1)
