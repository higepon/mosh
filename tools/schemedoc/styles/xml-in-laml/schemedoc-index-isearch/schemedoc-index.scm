...
(define manual-index-software-directory (string-append laml-dir "styles/xml-in-laml/schemedoc-index-isearch/"))
...
;             (font 'size "5" 'color (rgb-color-encoding red) (b index-title)) _ ":" (br)
              ...
              (form 'onsubmit "return false;" 'action "" 'target"ref"
                    (div "Search")
                    (div (input 'type "text" 'id "pattern" 'name "pattern" 'onfocus "this.select()" 'onkeyup "grep(this.value)" 'onkeydown "return isearchHandler(event);"))
                    (input 'type "hidden" 'size "3" 'value "40" 'id "max")
                    (input 'type "hidden" 'name "show_page_name_p" 'checked "checked" 'onclick "toggleShowPageName(this.checked)"))
