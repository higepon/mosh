...
(define schemedoc-software-directory (string-append laml-dir "styles/xml-in-laml/schemedoc-2-for-monar/"))
...
;;         )
            ...
            (left-middle-right-banner (span (a 'href "./manual.html#MANUAL-INDEX" "Manual alphabetic index")) "" (span 'class "manual-top-banner-when-generated" (when-generated) " by Higepon using " (a 'href "http://www.cs.aau.dk/~normark/schemedoc/" "schemedoc")))
