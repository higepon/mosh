...
;;;; This is the XML-in-LAML mirror of XHTML1.0-strict which is derived from the XHTML DTD.<p>
;;;;
;;;; The <a href="../../lib/xml-in-laml/mirrors/man/xhtml10-strict-mirror.html">XHTML 1.0 mirror functions</a>
...
;;;; (time, color, file-read, and of course the XHTML1.0 mirror libraries mentioned above).
...
;;;;
;;;; Usage: <kbd>(laml-style "simple-xhtml1.0-strict-validating")</kbd><p>
;;;; There are no external definitions in this library.
;;;; .title Manual of the LAML style for the XHTML1.0 strict - validating mirror
