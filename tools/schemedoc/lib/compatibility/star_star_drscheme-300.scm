...
; Very similar to star_start_mzscheme-300.scm.
; But no prevention of block buffering.

;;;; .title Reference Manual of the DrScheme 300+ LAML compatibility libray.
;;;; DrScheme specific stuff to be loaded for compatibility. 
...
;;;; in LAML already happens to exist in MzScheme and DrScheme. These are 
